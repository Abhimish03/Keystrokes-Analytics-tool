...
start_button = tk.Button(window, text="Start Keystroke Analytics tool", command=start_keylogger)
start_button.pack(pady=10)

stop_button = tk.Button(window, text="Stop Keystroke Analytics tool ", command=stop_keylogger)
